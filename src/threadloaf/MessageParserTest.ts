...
export class MessageParserTest {
    ...
    public async getTests(): Promise<Test[]> {
        return [
            ...
            {
                name: "parse cozy-unread-bar.html",
                fn: async (): Promise<void> => {
                    deepEqual(this.parser.parseMessages(await this.loadTestFile("cozy-unread-bar.html")), [
                        {
                            id: "1327855379354226718",
                            author: "User2",
                            timestamp: 1736655792798,
                            content: "lol yea “watch later” is the Steam backlog of video content",
                            htmlContent:
                                '<div id="message-content-1327855379354226718" class="markup_f8f345 messageContent_f9f2ca"><span>lol yea “watch later” is the Steam backlog of video content</span></div>',
                            parentId: "1327853482782359572",
                            parentPreview: {
                                author: "User1",
                                content:
                                    "<span>I have like 500 videos in my “watch later” that all look super interesting</span><span>. I’ll never get to them all</span>",
                            },
                            children: [],
                            originalElement: {},
                            authorColor: "",
                        ...
                        {
                            id: "1327879756766777425",
                            author: "User3",
                            timestamp: 1736661604826,
                            content: "Lot of good pbs videos in my watch later I need to get too.",
                            htmlContent:
                                '<div id="message-content-1327879756766777425" class="markup_f8f345 messageContent_f9f2ca"><span>Lot of good pbs videos in my watch later I need to get too</span><span>.</span></div>',
                            children: [],
                            originalElement: {},
                            authorColor: "",
                            isGhost: false,
            ...
            {
                name: "parse compact-unread-bar.html",
                fn: async (): Promise<void> => {
                    deepEqual(this.parser.parseMessages(await this.loadTestFile("compact-unread-bar.html")), [
                        {
                            id: "1327855379354226718",
                            author: "User2",
                            timestamp: 1736655792798,
